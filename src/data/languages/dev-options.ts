export const devOptions = [
  {
    ...
    rules: 'Используй ES6+ синтаксис (const/let, arrow functions). Модульная система (ESM).',
    tools: [
      {code: 'jest', name: 'Jest'},
  ...
  },
  {
    code: 'vue',
    name: 'Vue.js (3.x)',
    rules: 'Используй Composition API (<script setup>). Избегай Options API для нового кода. Однофайловые компоненты (.vue).',
    tools: [
      {code: 'vitest', name: 'Vitest'},
  ...
  {
    id: 'react', name: 'React (JS/TS)',
    rules: "Используй функциональные компоненты и Hooks. Избегай class components. Соблюдай правила хуков.",
    tools: [
  ...
  },
  {
    code: 'python',
    name: 'Python',
    rules: 'Следуй PEP8. Используй типизацию (Type Hints). Пиши чистый, модульный код.',
    tools: [
  ...
  },
  {
    code: 'go',
    name: 'Go (Golang)',
    rules: 'Следуй Effective Go. Обрабатывай ошибки явно. Используй контексты для отмены операций.',
    tools: [
